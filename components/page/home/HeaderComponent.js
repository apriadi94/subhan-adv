        ...
        <div className="grid md:grid-cols-5">
            <div className="md:col-span-3 mx-10 mt-5 md:mt-14">
                ...
                <div className="flex mt-5 md:mt-14 gap-5 mb-5">
                    <button className="bg-green-600 hover:bg-green-800 text-white font-bold py-2 px-10 rounded">My Resume</button>
                    <button className="bg-gray-600 hover:bg-gray-800 text-white font-bold py-2 px-10 rounded">My Projects</button>
                </div>
            </div>
